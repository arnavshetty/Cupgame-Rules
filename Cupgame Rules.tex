...
A lineage of cup game adjudicators exists that is self-selecting and a large part of the game's tradition on the team. The Cup Master was initially sole member of this committee, assuming all responsibilities of legislation, punitive enforcement, and communication of the rules. The typical term of the Cupmaster is 4 years, or the duration of their attendance at the 5Cs. The tradition is for the graduating Cupmaster to appoint one of the frosh in the Spring semester, although this is not a requirement. 

In 2023, a Cup Game Board was designed to help distribute responsibilities and create a more diverse legislative body that was not viewed as monarchist. It originally comprised 3 elected members; in September 2026 it was expanded to 4 elected members, nominated by the Cross Country team and approved by the standing Cupmaster. The Cup Master serves as an honorary 5th member to break ties in legislative and judicial disputes. Board members' terms are more fluid than the Cup Master's; they may resign at will, after which new elections are held. The Cup Master remains a spiritual and cultural guide for the Cup Game on CMS Cross Country, while the board handles legislative and judicial matters.

A list of past Cup Masters (and advisory boards if applicable) is given below

\subsubsection{List of Cup Masters}
\begin{center}
    \includegraphics*[width=0.7\linewidth]{fig/wilson.jpg}

    Wilson Ives HM '20, 2016--2020

    \includegraphics*[width=0.7\linewidth]{fig/henry.png}

    Henry Pick HM '23 (self-proclaimed), 2020--2023

    \includegraphics*[width=0.7\linewidth]{fig/jabro.png}

    Matthew Jabro CM '26, 2023--2026

    \includegraphics*[width=0.7\linewidth]{fig/shetty.jpg}

    Arnav Shetty HM '28, 2026--Present
\end{center}
\subsubsection{Cup Game Board Members}

\begin{center}
\begin{tabular}{llc}
Jackson Giumarra & HM '29 & 2026--Present \\
Jacob Pippel     & CM '28 & 2026--Present \\
Skye Georgiadis  & SC '29 & 2026--Present \\
Sophie Saleh     & HM '28 & 2026--Present \\
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item 19 Mar. 2023---Marina Muncan Oly. attends a Hoch wet burrito team meal
\end{itemize}
\section{Amendments}
\end{document}